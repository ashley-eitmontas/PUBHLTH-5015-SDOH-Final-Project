...
-   `docs/` → Final report (`report.Rmd`) and knitted outputs (PDF/HTML).
...
-   Key findings on asthma prevalence, poverty, and household income.

-   How asthma prevalence is linked to social determinants of health.

-   Policy implications for addressing health disparities in U.S. communities.
